  ...
  return (
    <div className='flex flex-col bg-[#def5fb] items-center overflow-x-hidden w-[100%] justify-center font-tangosans'>
      <div className='flex flex-col items-center text-center'>
        <h1 className='w-[844px] h-[148px] font-extrabold text-[64px] max-lg:text-[48px] leading-[70px] flex items-end text-center text-[#123C7B] flex-none order-0 flex-grow-0 max-w-[90vw] max-sm:text-[32px] max-sm:leading-[36px] max-md:text-[48px] max-md:leading-[52px] font-tangosans'>

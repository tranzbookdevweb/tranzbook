  ...
  return (
    <div className="w-full max-w-6xl pt-10 mx-auto px-4">
      {activeButton === "bus" && (
        <>
           {/* Hero Section */}
          <div className="relative bg-gradient-to-r from-orange-400 lg:h-96 to-yellow-400 rounded-2xl overflow-hidden mb-16">
            <div className="flex flex-col lg:flex-row items-center min-h-[300px] lg:min-h-[300px]">
              ...
              <div className="flex-1 p-8 md:p-12 z-10 relative">
                ...
                <p className="text-white/90 text-lg mb-6 max-w-md">
                  Join over 200+ travelers journeying across Ghana and beyond with unmatched ease and comfort every
                  day.
                </p>
                <Button
                  asChild
